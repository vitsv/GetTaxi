...
namespace Dashboard.Infrastructure
{
    public static class HttpResponseBaseExtensions
    {
        ...
        /// <returns></returns>
        public static int SetAuthCookie<T>(this HttpResponseBase responseBase, string login, bool rememberMe, T userData)
        {
            // Create own cookies based on original
            var cookie = FormsAuthentication.GetAuthCookie(login, rememberMe);
